        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Specializing in fullstack web development with focus on modern technologies 
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Currently building skills through academic coursework and personal projects, 
                    focusing on fullstack development and creative problem-solving.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                      <span className="text-sm text-gray-600 dark:text-gray-300">
                        Developed news management system with Node.js and MySQL
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl p-6 border border-emerald-200 dark:border-emerald-800">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Eager to apply my academic knowledge and personal project experience in a 
                professional environment. Open to internships, entry-level positions, and 
                collaborative projects that will help me grow as a developer.
              </p>
            </div>
          </div>
        </div>
