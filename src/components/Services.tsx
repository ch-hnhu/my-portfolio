	...
	const services = [
		{
			...
			description:
				"Complete frontend and backend development services for web applications and websites.",
			features: [
		...
		},
		{
			...
			description:
				"Creating mobile-first, responsive designs that work perfectly across all devices.",
			features: [
		...
		},
		{
			...
			title: "UI/UX Design",
			description:
				"Designing intuitive and visually appealing user interfaces with great user experience.",
			features: [
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
								...
								<ul className='space-y-2'>
									{service.features.map((feature, featureIndex) => (
										<li
											...
											<div
												className={`w-2 h-2 bg-gradient-to-r ${colors.gradient} rounded-full mr-3`}></div>
											{feature}
										</li>
									))}
								</ul>
				...
				<div className='bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-8 md:p-12 text-center'>
					...
					<p className='text-emerald-100 text-lg mb-8 max-w-2xl mx-auto'>
						...
						collaborative opportunities. Let's discuss how we can work together to
					...
					<div className='flex flex-col sm:flex-row gap-4 justify-center'>
						...
						<a
							href='mailto:hnhu.dev@gmail.com'
