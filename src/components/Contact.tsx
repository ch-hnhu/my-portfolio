...
const Contact = () => {
	...
	const contactInfo = [
		...
		},
		{
			icon: Github,
			label: "GitHub",
			value: "github.com/ch-hnhu",
			href: "https://github.com/ch-hnhu",
			color: "purple",
		},
		{
			icon: MapPin,
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='text-center mb-16'>
					...
					<p className='text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto'>
						Ready to collaborate on your next project? Let's build something great
						together!
					</p>
				</div>
					...
					<div className='space-y-8'>
						<div>
							...
							<p className='text-gray-600 dark:text-gray-300 mb-8'>
								...
								opportunities. Whether you're looking for a developer, want to
						...
						<div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
							{contactInfo.map((info, index) => {
								...
								const colorClass =
									colorVariants[info.color as keyof typeof colorVariants];
						...
						<div className='bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-6 text-white'>
							...
							<p className='text-emerald-100'>
								I'm excited to work on innovative projects and contribute to
